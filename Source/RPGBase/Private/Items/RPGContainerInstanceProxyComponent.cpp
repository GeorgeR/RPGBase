...
//
//void UContainerInstanceProxyComponent::SetContextAs(URPGContainerInstanceComponent* InContext)
//{
...
//}
//
//URPGContainerInstanceComponent* UContainerInstanceProxyComponent::GetContextAs() const
//{
//	return Context;
//}
//
...
//}
//
//bool UContainerInstanceProxyComponent::Server_TransferItem_Validate(int32 InSourceSlot, URPGContainerInstanceComponent* InDestinationContainer, int32 InDestinationSlot) { return true; }
//void UContainerInstanceProxyComponent::Server_TransferItem_Implementation(int32 InSourceSlot, URPGContainerInstanceComponent* InDestinationContainer, int32 InDestinationSlot)
//{
//	check(Context);
//	Context->TransferItem(InSourceSlot, InDestinationContainer, InDestinationSlot);
//}
//
//void UContainerInstanceProxyComponent::Client_TransferItem_Implementation(float InTimeStamp, int32 InSourceSlot, URPGContainerInstanceComponent* InDestinationContainer, int32 InDestinationSlot)
//{
//	check(Context);
//
