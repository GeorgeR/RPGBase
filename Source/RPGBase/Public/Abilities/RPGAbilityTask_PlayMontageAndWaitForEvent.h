 ...
 */
UCLASS()
class RPGBASE_API URPGAbilityTask_PlayMontageAndWaitForEvent
	: public UAbilityTask
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "RPG Base|Ability|Tasks", meta = (HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE"))
...
template <typename TComponent>
TComponent* URPGAbilityTask_PlayMontageAndWaitForEvent::GetTargetAbilitySystemComponent()
{
